...
<template>
  <footer class="bg-white fixed bottom-0 w-full">
    <div class="max-w-7xl mx-auto py-6 md:py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
...
<script setup>
    ...
    const navigation = [
        {
            name: 'Linkedin',
            href: 'https://www.linkedin.com/in/alexandre-quere/',
            icon: '<i class="fa-brands fa-linkedin-in"></i>'
        },
        {
            name: 'GitHub',
            href: 'https://github.com/alexeinkere',
